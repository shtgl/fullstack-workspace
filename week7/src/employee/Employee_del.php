...
<html>
	...
	<body>
		...
		<div class="container">
			<h2>Delete data from Employee</h2>
		...
		<?php 
			if($_GET['submit']){
				...
				$query="DELETE FROM employee where emp_id='$rn1'";
				$data=mysqli_query($conn,$query);
				if($data){
					echo "<font color='green'>Record deleted successfully <a href='Employee.php'>Check updated list here</a>";
				}
				else{
