	...
	<body>
		...
		<?php 
			if($_GET['submit']){
				...
				$query="UPDATE visitor SET vis_name='$rn12',vis_phone='$rn13',soc_id='$rn14' where vis_id='$rn1'";
				$data=mysqli_query($conn,$query);
				if($data){
					echo "<font color='green'>Record Updated successfully <a href='Visitor.php'>Check updated list here</a>";}
					else{
