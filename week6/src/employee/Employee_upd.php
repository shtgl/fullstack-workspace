...
<html>
	...
	<body>
		<div class="top-nav-bar">
			...
			<div class="menu-bar">
				<ul>
					<li><a href="../Index.html.html"><i class="fa fa-home"></i>Home</a></li>
		...
		<?php 
			if($_GET['submit']){
				...
				$query="UPDATE employee SET emp_name='$rn12',emp_type='$rn13',emp_salary='$rn14',soc_id='$rn15' where emp_id='$rn1'";
				$data=mysqli_query($conn,$query);
				if($data){
					echo "<font color='green'>Record Updated successfully <a href='Employee.php'>Check updated list here</a>";
				}
				else{
